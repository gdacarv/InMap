...
public enum StoreCategory {
	...
	GIFTS(3, R.string.title_gifts, R.drawable.pin_cat_presente, R.drawable.img_cat_presentes, 0xff8d157f, R.drawable.pin_cat_presente),
	SHOES(4, R.string.title_shoes, R.drawable.pin_cat_sapatos, R.drawable.img_cat_sapatos, 0xff564a3e, R.drawable.pin_cat_sapatos),
	...
	SERVICES(10, R.string.title_services, R.drawable.pin_cat_servicos, R.drawable.img_cat_servicos, 0xff959595, R.drawable.pin_cat_servicos),
	...
	HEALTH(13, R.string.title_health, R.drawable.pin_cat_saude, R.drawable.img_cat_saude, 0xffa01211, R.drawable.pin_cat_saude), 
	UNISSEX(14, R.string.title_unissex, R.drawable.pin_cat_unisex, R.drawable.img_cat_unisex, 0xff760229, R.drawable.pin_cat_unisex), 
	...
	HOME(24, R.string.title_home, R.drawable.pin_cat_utilidades_casa, R.drawable.img_cat_utilidades_casa, 0xff663333, R.drawable.pin_cat_utilidades_casa);
